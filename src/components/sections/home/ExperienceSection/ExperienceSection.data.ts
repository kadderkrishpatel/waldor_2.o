  ...
  cards: [
    {
      ...
      icon: "/assets/waldor/ritual-icon.png",
      description:
    ...
    },
    {
      ...
      icon: "/assets/waldor/transparency-icon.png",
      description:
    ...
    },
    {
      ...
      icon: "/assets/waldor/molecule-icon.png",
      description:
    ...
    },
    {
      ...
      icon: "/assets/waldor/personalised-icon.png",
      description:
